...
export const navigationConfig: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Schedule', url: '/schedule', icon: CalendarDays, roles: ['superadmin', 'admin', 'support', 'teacher', 'student', 'parent'] },
      ...
      { title: 'Materials', url: '/materials', icon: FileText, roles: ['superadmin', 'admin', 'teacher', 'student'] },
