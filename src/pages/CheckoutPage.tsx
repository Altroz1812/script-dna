...
// Add email/password sign up function
...
function AuthGateStep({
  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground mb-8 text-center max-w-sm">Please sign in to proceed with enrollment.</p>

      {/* Google Sign In */}
      <Button size="lg" onClick={onGoogleSignIn} className="gap-2 w-full max-w-sm mb-4">
      ...
      {/* Email/Password Form */}
      <form onSubmit={onEmailSubmit} className="w-full max-w-sm space-y-4">
        <div>
